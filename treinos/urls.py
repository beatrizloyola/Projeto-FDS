...
from .views import criar_treino_view, listar_treinos_view, editar_treino_view, excluir_treino_view, concluir_treino_view
...
urlpatterns = [
    ...
    path("<int:treino_id>/concluir/", concluir_treino_view, name="concluir_treino"),
]
